...
namespace DataBase2.Clases.Archivos
{
    public class ClsConexion
    {
        ...
        public ClsConexion()
        {
            ...
            //_conexion = "Data Source=LAPTOP-9ITQKIPO;Initial Catalog=dbprogra;Integrated Security=True";
            _conexion = "Server=localhost; Database=dbprogra; Uid=root; Pwd=password";
